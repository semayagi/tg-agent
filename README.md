...
### Как узнать Chat ID
#### Способ 1
Добавить бота в чат, затем добавить в этот же чат бота @Getmyid_bot - он сообщит chat ID

#### Способ 2
Добавить бота в чат, написать там любое сообщение, затем открыть в браузере:
```
